...
<div class="container" id="gestion-participant">
	<div class="row form-group">
		<div class="col-lg-6 col-md-6 col-xs-6">
		 <label for="pseudo">Pseudo</label><label id="lbl-pseudo">Female</label>
			<input class="form-control" id="pseudo" aria-describedby="pseudoHelp"
				placeholder="Pseudo" required>
		</div>
	</div>
	<div class="row form-group">
		<div class="col-lg-6 col-md-6 col-xs-6">
			<input class="form-control" id="prenom" aria-describedby="prenomHelp"
